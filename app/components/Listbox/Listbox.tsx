...
/**
 * Properties for the {@link Listbox} component.
 *
 * @typeParam T - The combined type for all option values.
 * @see Headless UI's {@link ListboxProps}
 * @see Headless UI's {@link ListboxButtonProps}
 * @see Headless UI's {@link ListboxSelectedOptionProps}
 */
type ListboxProps<T> = Pick<ListboxSelectedOptionProps, "placeholder"> &
  Pick<ListboxButtonProps, "className" | "autoFocus" | "aria-label"> &
...
/**
 * A listbox dropdown field.
 *
 * @see {@link ListboxProps}
 */
...
/**
 * Properties for the {@link ListboxOption} component.
 *
 * @typeParam T - The option value.
 * @see Headless UI's {@link ListboxOptionProps}
 * @see {@link HTMLDivElement}
 */
type ListboxOptionProps<T> = Pick<
...
/**
 * Option for a {@link Listbox}.
 *
 * @see {@link ListboxOptionProps}
 */
...
/**
 * Description for a {@link Listbox}.
 *
 * @see {@link HTMLSpanElement}
 */
