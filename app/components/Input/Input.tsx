 ...
 *
 * @see Headless UI's {@link HeadlessInputProps InputProps}
 */
type InputProps = {
  /** The type of input. */
  type?:
  ...
  return (
    <span
      ...
      className={clsx([
        ...
        // Background color + shadow applied to inset pseudo element, so shadow
        // blends with border in light mode
    ...
    >
      <HeadlessInput
        ...
        className={clsx([
          // Date classes
          props.type &&
            dateTypes.includes(props.type as never) && [
