...
This is a common joke among email developers, but it still holds true. The more
you can stick to the HTML 4 spec, the better. Effectively, this means no modern
HTML tags or CSS properties, and styles should be converted to attributes
wherever applicable.
...
section above and dealing with HTML attributes. This leads me into my final tip:
