...
date: 2024-07-08
description: Getting Cloudflare's `cloudflared` CLI tool working with FreeBSD (and variants) is easy, but completely undocumented. Here's how to get it working with Cloudflare's remotely-managed Zero Trust tunnels.
---
